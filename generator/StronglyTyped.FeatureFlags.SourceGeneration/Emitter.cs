...
internal class Emitter {
    ...
    private void CreateInterface(SectionDefinition definition) {
        _builder.Append(@$"
...
");
    ...
    private void CreateClass(SectionDefinition definition) {
        _builder.Append(@$"
using StronglyTyped.FeatureFlags;
